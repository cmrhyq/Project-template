...
public class HouseDao {
    ...
    private static final String URL = "jdbc:mysql://bj.kevinkda.cn/hsir_graduation_project?" + "user=root&password=password&useUnicode=true&characterEncoding=UTF8&serverTimezone=UTC";
